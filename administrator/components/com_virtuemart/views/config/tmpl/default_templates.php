 ...
 * @version $Id: default_templates.php 7033 2013-06-25 18:06:44Z Milbo $
 */
...
<fieldset>
	...
	<table class="admintable">
		<tr>
			...
			<td>
				<?php echo JHTML::_('Select.genericlist', $this->jTemplateList, 'vmtemplate', 'size=1 width=200', 'value', 'name', VmConfig::get('vmtemplate', 'default')); ?>
			</td>
		</tr>
		<tr>
			<td class="key">
			...
			<td>
				<?php echo JHTML::_('Select.genericlist', $this->jTemplateList, 'categorytemplate', 'size=1', 'value', 'name', VmConfig::get('categorytemplate', 'default')); ?>
			</td>
		</tr>
		<tr>
			<td class="key">
		...
		<tr>
			...
			<td>
				<?php echo JHTML::_('Select.genericlist', $this->categoryLayoutList, 'categorylayout', 'size=1', 'value', 'text', VmConfig::get('categorylayout', 0)); ?>
			</td>
		</tr>
		<tr>
			<td class="key">
		...
		<tr>
			...
			<td>
				<?php echo JHTML::_('Select.genericlist', $this->productLayoutList, 'productlayout', 'size=1', 'value', 'text', VmConfig::get('productlayout', 0)); ?>
			</td>
		</tr>
		<tr>
			<td class="key">
...
<fieldset>
	...
	<table class="admintable">
		...
		<tr>
			...
			<td>
				<?php echo JHTML::_('Select.genericlist', $this->noimagelist, 'no_image_set', 'size=1', 'value', 'text', VmConfig::get('no_image_set')); ?>
			</td>
		</tr>
		<tr>
			<td class="key">
...
<fieldset>
	...
	<table class="admintable">
		<tr>
			...
			<td>
				<?php echo JHTML::_('Select.genericlist', $this->vmLayoutList, 'vmlayout', 'size=1', 'value', 'text', VmConfig::get('vmlayout', 0)); ?>
			</td>
		</tr>
		<tr>
			<td class="key">
...
<fieldset>
	...
	<table class="admintable">
		...
		<tr>
			...
			<td>
				<?php echo VmHTML::checkbox('google_jquery', VmConfig::get('google_jquery', '1')); ?>
			</td>
		</tr>
	</table>
</fieldset>
